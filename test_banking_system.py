...
class TestBankingSystem(unittest.TestCase):
    ...
    def test_withdraw(self):
        ...
        withdraw(self.accounts['John'], 200)
        self.assertEqual(self.accounts['John']['balance'], 300)  # Insufficient funds
    ...
    def test_transfer(self):
        ...
        self.assertEqual(self.accounts['John']['balance'], 200)  # Insufficient funds
        self.assertEqual(self.accounts['Jane']['balance'], 1300)
